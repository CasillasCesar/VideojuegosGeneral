# Portafolio de Evidencias: Creación de Videojuegos (Unidad II)
...
## Descripción General
Este repositorio contiene el portafolio de evidencias correspondiente a la **Unidad II: Programación orientada a objetos para videojuegos**. El trabajo presentado demuestra la aplicación práctica de conceptos de programación en Unity, estructurado en tutoriales guiados, ejercicios prácticos y el desarrollo de un videojuego en versión Beta.

> **Nota Técnica:** Todo el desarrollo cuenta con un historial de versiones detallado (Commits) que evidencia el progreso incremental y la autoría del código.
...
> [!IMPORTANT]
> **Acceder al Documento de Evidencias:**
> 👉 **[📄 Click aquí para ver las Bitácoras de los Tutoriales (Word)](https://drive.google.com/drive/folders/1a_ScjDJwyWb0mh6D2gBJelLB8iQaC_zx?usp=drive_link)**
...
Declaro que el código fuente y los documentos presentados en este portafolio son de mi autoría, apoyado en los recursos didácticos proporcionados por la asignatura.

**Firma:** César Daniel Casillas Céspedes
